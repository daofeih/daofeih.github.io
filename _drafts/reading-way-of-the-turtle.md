---
layout: post
title: Reading "Way of the Turtle"
categories: [Notes, Book Notes]
tags: [economics, investing, trading]
media_subpath: /assets/img/posts/reading-way-of-the-turtle
math: true
---
...
| Author | [Curtis Faith](https://www.turtletrader.com/curtis-faith/) |
| Publisher | McGraw-Hill |
| Published Year | 2007 |

## Foreword by Van K. Tharp

Van K. Tharp, the author of *Trade Your Way to Financial Freedom*.

> ... this is one of the five best trading books ever written, ...

> In my opinion, their success was due entirely to their
psychology and their position sizing.

The ability to execute the trading system is more important than the trading system itself.

## Chapter 1. Risk Junkies

One of the functions of financial markets is transferring risk.

> In his informative and engaging book *Against the Gods: The Remarkable Story of Risk*, Peter Bernstein discusses how markets developed to allow the transfer of risk from one party to another.
...
it targets shorter-term market moves.
...
to exit the market before it closes each day.

### Watching the Market State

> A Turtle never tries to predict market direction but instead *looks
for indications that a market is in a particular state*.

## Chapter 3. The First $2 Million Is the Toughest

### The Science of Controlled Risk

1. Put the positions in small chunks.
2. Determine the position size based on the *average true range*.
